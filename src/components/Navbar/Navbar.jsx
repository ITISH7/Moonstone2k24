                ...
                {isOpen && (
                  <Drop onClick={() => setMobile(!mobile)} activeClass={classes.active} to="ambassador" spy="true" smooth={true} offset={-100} duration={600} style={{ color: "white", textDecoration: "none" }}>
                    ...
                    <div className={classes.dropdowncontent}>
                      ...
                      <Link to="/cultural" className={classes.chotu}>Cultural</Link>
                      <Link to="/techno" className={classes.chotu}>Techno</Link>
                      <Link to="/sports" className={classes.chotu}>Sports</Link>
                      <Link to="/night" className={classes.chotu}> Nights</Link>
