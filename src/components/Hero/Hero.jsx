    ...
    <section id="home" className={classes.hero}>
      <div className={classes.herobox}>
        <div className={classes.headerbox}>
          ...
          <h1 className={classes.hero_tag}>
            <i>Moonstone </i>
            <span>
              <h6 className={classes.hero_tag1}>2k24</h6>
            </span>
          </h1>
          {/* <h4 className={classes.caption}>
          </h4> */}
          <h4 className={classes.caption}>Unlock Your Brilliance:</h4>
          ...
          <Link
            ...
            to="/events"
          >
            <Button link="/events" label="Explore Our Events" className={classes.btn}></Button>
          </Link>
        </div>
