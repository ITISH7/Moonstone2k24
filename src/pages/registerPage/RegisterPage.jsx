...
const BasicDetails = (props) => {
  ...
  const submitHandler = (event) => {
    ...
    if (fullName === "" || email === "" || Phonenumber === "" || validateAdhaar(adharnumber) === "false" || gender === null || collegename === "") {
    ...
    <>
      <div className={styles.registerpage}>
        <Card>
          ...
          {!zerostep && <BasicDetails activeStep={activeStep} nextstep={getbasicdataHandler} length={length} />}
          ...
          {finalstep && notsubmitted && (
            <div className={classes.final_submit}>
              <h3 className={classes.final_submit_text}>Thanks for Registration!! please click on Final Submit to submit and wait for alert or pop up message</h3>
